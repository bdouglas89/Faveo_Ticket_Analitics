...
export const UploadSection: React.FC<UploadSectionProps> = ({ onUploadSuccess, isLoading }) => {
  ...
  const downloadExcelTemplate = () => {
    const sampleData = [
      {
        "Ticket Number": "INC-AAAA-5018",
        "Subject": "Gradillas de acero inoxidable",
        "Status": "Abierto",
        "Department": "Biobanco",
        "Type": "Solicitud de Cotización",
        "Owner": "Angel Antonio Ondoy Salas",
        "Assigned Agent": "Jennifer Tatiana Rodriguez Barboza",
        "Creator": "Angel Antonio Ondoy Salas",
        "¿La compra es mayor a $2000?": "No",
        "Created At": "julio 28, 2026 10:27 AM",
        "Fecha Límite para realizar la compra": "31-08-2026, 12:00 am",
        "fecha_finalizada": "",
        "fecha_pendiente_verificacion": "",
        "Closed At": ""
      },
      {
        "Ticket Number": "INC-AAAA-4963",
        "Subject": "Laptop - Asistente Infraestructura",
        "Status": "Abierto",
        "Department": "Unidad de Gestión de Infraestructura",
        "Type": "Solicitud de Cotización",
        "Owner": "Alvaro Gomez",
        "Assigned Agent": "Jennifer Tatiana Rodriguez Barboza",
        "Creator": "Alvaro Gomez",
        "¿La compra es mayor a $2000?": "Si",
        "Created At": "julio 15, 2026 1:52 PM",
        "Fecha Límite para realizar la compra": "31-07-2026, 11:00 am",
        "fecha_finalizada": "",
        "fecha_pendiente_verificacion": "",
        "Closed At": ""
      },
      {
        "Ticket Number": "INC-AAAA-4950",
        "Subject": "Esterilización y autoclave instrumental",
        "Status": "En proceso pago",
        "Department": "Unidad Gestión Médica Integral",
        "Type": "Solicitud de pago de servicios/facturas",
        "Owner": "Rebecca Ocampo",
        "Assigned Agent": "Michael Leiton Chichilla",
        "Creator": "Rebecca Ocampo",
        "¿La compra es mayor a $2000?": "No",
        "Created At": "julio 13, 2026 11:15 PM",
        "Fecha Límite para realizar la compra": "16-07-2026, 12:00 am",
        "fecha_finalizada": "28-07-2026",
        "fecha_pendiente_verificacion": "20-07-2026",
        "Closed At": "julio 28, 2026 7:51 AM"
      }
    ];
